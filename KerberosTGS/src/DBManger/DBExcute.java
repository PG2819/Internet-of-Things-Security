...
public class DBExcute {
	...
	public static int register(String userName, String passwd) {
		...
		if (re == 0) {
			System.err.println("Register failed! Please retry!");
			return 0;
		}
	...
	public static int logIn(int userID) {
		...
		if (re == 0) {
			System.err.println("user statue update failed");
			return 0;
		}
		return 1;
	}
	...
	public static int changePasswd(int userID, String newPasswd) {
		...
		int re = DataConn.executeUpdate(sql);
		if (re == 0) {
			System.err.println("password changing has failed!");
			return 0;
		}
		System.out.println("password changing has succeed");
		return 1;
	}
	...
	public static int offline(int userID) {
		...
		int re = DataConn.executeUpdate(sql);
		if (re == 0) {
			System.err.println("user offline failed!");
			return 0;
		}
		System.out.println("user offline succeed");
		return 1;
	}
	...
	public static int recordInformation(Information info, int status) {
		...
		int re = DataConn.executeUpdate(sql);
		if (re == 0) {
			System.err.println("message record succeed！");
			return 0;
		}
		Date date = new Date();
		...
		if (re == 0) {
			System.err.println("message record failed！");
			return 0;
		}
		return 1;
	}
...
//		//addFriend(1,2);
//		/*
//		List<User> persons = viewFriends(2);
//		for(User u: persons){
//			System.out.println(u);
//		}
//		JSONObject jsonObject = new JSONObject();
//		jsonObject.put("data", persons);
