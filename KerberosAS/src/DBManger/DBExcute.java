...
public class DBExcute {
	...
	public static int logIn(int userID) {
		...
		if (re == 0) {
			System.err.println("User status update failed !");
			return 0;
		}
		return 1;
	}
	...
	public static int offline(int userID) {
		...
		System.out.println("User offline successfully !");
		return 1;
	}
	...
	public static int addFriend(int userID, int friendID) {
		...
		int re = DataConn.executeUpdate(sql);
		if (re == 0) {
			System.err.println("Failed to add friend !");
			return 0;
		}
	...
	public static int recordInformation(Information info, int status) {
		...
		int re = DataConn.executeUpdate(sql);
		if (re == 0) {
			System.err.println("Message logging failed !");
			return 0;
		}
		Date date = new Date();
	...
	public static int infoStatusChange(int to) {
		...
		int re = DataConn.executeUpdate(sql);
		if (re == 0) {
			System.err.println("Message status update failed !");
			return 0;
		}
		return 1;
	}
